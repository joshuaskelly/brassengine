...
static const struct luaL_Field gamecontroller_buttons[] = {
    ...
    {"LEFT_STICK", CONTROLLER_BUTTON_LEFT_STICK},
    {"RIGHT_STICK", CONTROLLER_BUTTON_RIGHT_STICK},
    {"LEFT_SHOULDER", CONTROLLER_BUTTON_LEFT_SHOULDER},
    {"RIGHT_SHOULDER", CONTROLLER_BUTTON_RIGHT_SHOULDER},
...
static const struct luaL_Field gamecontroller_axes[] = {
    {"LEFT_X", CONTROLLER_AXIS_LEFT_X},
    {"LEFT_Y", CONTROLLER_AXIS_LEFT_Y},
    {"RIGHT_X", CONTROLLER_AXIS_RIGHT_X},
    {"RIGHT_Y", CONTROLLER_AXIS_RIGHT_Y},
    {"TRIGGER_LEFT", CONTROLLER_AXIS_TRIGGER_LEFT},
    {"TRIGGER_RIGHT", CONTROLLER_AXIS_TRIGGER_RIGHT},
    {NULL, 0}
};
